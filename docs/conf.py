# -*- coding: utf-8 -*-
#
# python-debian documentation build configuration file, created by
# sphinx-quickstart on Sun Mar 18 23:44:05 2018.
#
...
#
# html_title = u'python-debian v0.1.32'
...
htmlhelp_basename = 'python-debiandoc'
...
def skip_members(app, what, name, obj, skip, options):
  if name.startswith("_abc"):
    return True  # skip the _abc* members from collections
